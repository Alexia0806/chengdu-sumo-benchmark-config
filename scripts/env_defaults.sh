...
: "${DOWNLOAD_ROOT:=$AUTODL_ROOT/model_downloads_20260624}"
: "${TMP_ROOT:=${TMPDIR:-/tmp}}"
...
export BENCH_ROOT DEEPSIGNAL_BENCH_ROOT DEFAULT_TARGET_TLS DEFAULT_UNBALANCED_X15_TLS
export DEFAULT_TARGET_PEAK_ROUTE_SELECTION
export PYTHON_BIN SYSTEM_PYTHON_BIN
export LLAMA_CPP_ROOT LLAMA_SERVER
export HF_HOME HUGGINGFACE_HUB_CACHE WATCH_ROOT PATCH_ROOT DOWNLOAD_ROOT
export TMP_ROOT
export SUMO_HOME
